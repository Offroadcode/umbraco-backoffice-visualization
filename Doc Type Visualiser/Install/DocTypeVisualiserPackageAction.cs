...
namespace DocTypeVisualiser.Install.PackageActions
{
    public class TheDashboardPackageAction : IPackageAction
    {
        public string Alias()
        {
            return "DocTypeVisualiser";
        }
        ...
        public bool Execute(string packageName, XmlNode xmlData)
        {
            ...
            this.AddSectionDashboard("DocTypeVisualiser", "content", "Welcome", "/app_plugins/DocTypeVisualiser/DocTypeVisualiser.html");
        ...
        public bool Undo(string packageName, XmlNode xmlData)
        {
            ...
            this.RemoveDashboardTab("DocTypeVisualiser");
